<nav class="bg-navbar-bg text-white flex items-center justify-between px-4 py-2">
    <div class="flex items-center space-x-4">
        ...
        <a href="/browse" class="font-semibold text-gray-300 hover:text-white" id="nav-browse">Browse</a>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        `;
            ...
            <a href="/register" class="border border-brand-pink px-4 py-1.5 text-sm rounded-md hover:bg-pink-600 hover:text-white transition">
                Sign Up
            </a>
        `;
            });
